                                ...
                                <div class="col-sm-6">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100% !important;" id="selectInput01" name="modal-discount_item_id" class="select2-modal form-control" required>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="textInput1">Quantité Acheté <small class="text-danger" title="champ obligatoire">*</small></label>

                                            <input type="number" min="1" class="form-control" id="textInput1" name="modal-purchased_qty" placeholder="Quantité Acheté" required>
                                            <div class="invalid-feedback">Ce champ est obligatoire.</div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="textInput2">Quantité Gratuit <small class="text-danger" title="champ obligatoire">*</small></label>

                                            <input type="number" min="1" class="form-control" id="textInput2" name="modal-free_dishes_number" placeholder="Quantité Gratuit" required>
                                            <div class="invalid-feedback">Ce champ est obligatoire.</div>
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="col-sm-6">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="modal-description" id="textareaInput1"  placeholder="Détails du Promotion ..." style="margin-top: 0px; margin-bottom: 0px; height: 187px;resize:none"></textarea>
                                        </div>
                                    </div>
                                    <div class="col">
        ...
        <div class="panel panel-default panel-with-tabs" data-sortable="false">
            ...
            <div class="tab-content">
                        ...
                        <table class="table table-bordered widget-table widget-table-rounded" data-id="widget">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Quantité Gratuit</th>
                            ...
                            <tbody>
                                ...
                                $allDiscountQty = (new QuantityPromotion)->setRestaurantId(Session::get('user_id'))->getAllByRestaurantId();
                                foreach ($allDiscountQty as $discountQty) {
                                    ...
                                    $dishName = (new Dish)->setId($discountQty->getDiscountItemId())->getElementById();
                                    ?>
                                <tr id="<?= $discountQty->getId() ?>">
                                    ...
                                    <td class="text-center">
                                        <p style="font-size:12px" class="widget-table-desc m-b-15"><?= $dishName->getDishName() ?></p>
                                    </td>
                                    <td class="text-center">
                                        <b class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white"><?= $discountQty->getPurchasedQty() ?></b><br>
                                    </td>
                                    <td class="text-center">
                                        <b class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white"><?= $discountQty->getFreeDishesNumber() ?></b><br>
                                    </td>
                                    <td class="text-center">
                ...
                <div class="tab-pane fade" id="add">
                    ...
                    <legend class="m-b-15">Ajouter Promotion par Quantité</legend>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control" id="textInput1" name="purchased_qty" placeholder="Quantité Acheté" required>
                                        <div class="invalid-feedback">Ce champ est obligatoire.</div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control" id="textInput2" name="free_dishes_number" placeholder="Quantité Gratuit" required>
                                        <div class="invalid-feedback">Ce champ est obligatoire.</div>
                                    </div>
                                </div>
                                <div class="col">
                            ...
                            <div class="col-sm-6">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="textareaInput1">Description du Promotion</label>
                                        <textarea class="form-control" name="description" id="textareaInput1" placeholder="Détails du Promotion ..." style="margin-top: 0px; margin-bottom: 0px; height: 187px;"></textarea>
                                    </div>
                                </div>
                                <div class="col">
                                    <label for="switcher_checkbox_status ">Etat du Promotion</label>
